...
RSI_SHORT_MIN= 22     # снижен с 28: медвежий рынок опускает RSI до 20-28, нужно торговать
RSI_SHORT_MAX= 62     # расширен с 58: чуть больше зона входа в SHORT
ATR_PERIOD   = 14
...
BE_BUFFER    = 0.0
ADX_PERIOD   = 14
ADX_MIN      = 18     # снижен с 20: позволяет чуть больше сигналов в умеренном тренде
TIME_FILTER  = True   # пропускать 00:00-04:00 UTC (мёртвые часы)
EMA_SEP_MIN_PCT = 0.06  # ИСПРАВЛЕНО: снижен с 0.12 → 0.06 (в боковике EMA21/50 близко!)
                        # Диагностика: все монеты блокировались на 0.04-0.10%
                        # ADX>18 уже гарантирует тренд; 0.06 = дополнительная защита от флэта
ST_MULT      = 3.0
ST_PERIOD    = 10
MACD_FAST    = 12
MACD_SLOW    = 26
MACD_SIG     = 9
SRSI_PERIOD  = 14     # период StochRSI
SRSI_SMOOTH  = 3      # сглаживание StochRSI (K-линия)
SRSI_OB      = 82     # порог перекупленности для LONG (>82 = перекуплен, не входим)
SRSI_OS      = 5      # ИСПРАВЛЕНО: снижен с 15 → 5. В медвежьем рынке StochRSI часто
                      # остаётся 0-12, блокируя ВСЕ SHORT. Теперь блокируем только экстремум.
VOL_RATIO_MIN= 0.6    # снижен с 0.75: достаточно 60% среднего объёма для подтверждения
