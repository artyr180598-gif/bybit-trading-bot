...
A Python EMA crossover trading bot for Bybit BTC/USDT spot market.

- **File**: `bot/trading_bot.py`
- **Log**: `bot/bot.log`
- **Requirements**: `bot/requirements.txt`
- **Workflow**: "Trading Bot" — `python bot/trading_bot.py`

### Configuration (top of `bot/trading_bot.py`)

| Variable | Default | Description |
|---|---|---|
| `TESTNET` | `True` | Use Bybit testnet (set to `False` for live trading) |
| `SYMBOL` | `BTCUSDT` | Trading pair |
| `EMA_FAST` | `9` | Fast EMA period |
| `EMA_SLOW` | `21` | Slow EMA period |
| `RISK_PERCENT` | `3.0` | % of USDT balance risked per trade |
| `CHECK_INTERVAL` | `300` | Seconds between checks (5 min) |
| `KLINE_INTERVAL` | `"5"` | Candle size in minutes |
